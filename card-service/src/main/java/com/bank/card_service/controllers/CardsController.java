package com.bank.card_service.controllers;

import com.bank.card_service.constants.CardsConstants;
import com.bank.card_service.dtos.CardsContactInfoDto;
import com.bank.card_service.dtos.CardsDto;
import com.bank.card_service.dtos.ErrorResponseDto;
import com.bank.card_service.dtos.ResponseDto;
import com.bank.card_service.services.ICardsService;
...
public class CardsController {
    ...
    @GetMapping("/get-card-by-mobile-number")
    public ResponseEntity<CardsDto> getCardDetailsByMobileNumber(@RequestHeader("bank-correlation-id") String correlationId,
                                                                 @RequestParam @Pattern(regexp="(^$|[0-9]{10})",message = "Mobile number must be 10 digits") String mobileNumber) {
        log.info("bank-correlation-id found: {}", correlationId);
        CardsDto cardsDto = iCardsService.getCardByMobileNumber(mobileNumber);
